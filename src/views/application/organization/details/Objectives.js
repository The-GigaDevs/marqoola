...
import { getObjectivesForDivision, deleteObjective } from 'store/slices/objective';
...
const headCells = [
    { id: 'name', label: 'Objective Name', minWidth: 170 },
...
const Objectives = ({selectedOrganisation}) => {
    ...
    React.useEffect(() => {
        ...
        dispatch(getObjectivesForDivision(selectedOrganisation.id, user.accessToken));
    }, [dispatch]);

    React.useEffect(() => {
        setAssetTableData(objectives);
    }, [objectives]);
                            ...
                            .map((row, index) => {
                                ...
                                return (<>
                                    ...
                                    >
                                        ...
                                        <TableCell align="center"><Chip label={row.risks.length} /></TableCell>
