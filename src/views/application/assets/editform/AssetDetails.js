...
const AssetDetails = ({ assetDetailsData, setAssetDetailsData, handleNext, setErrorIndex, parentData }) => {
    ...
    const formik = useFormik({
        initialValues: {
            indirectassetvaluenumber: assetDetailsData.indirectassetvalue.number,
            indirectassetvaluecurrency: assetDetailsData.indirectassetvalue.currency,
            directassetvaluenumber: assetDetailsData.directassetvalue.number,
            directassetvaluecurrency: assetDetailsData.directassetvalue.currency,
        },
        validationSchema,
                ...
                <Grid container spacing={3}>
                    <Grid item xs={9} >
                        <TextField
                            ...
                            value={formik.values.indirectassetvaluenumber || assetDetailsData.indirectassetvalue.number}
                    ...
                    <TextField
                            ...
                            label="Currency"
                            value={formik.values.indirectassetvaluecurrency || assetDetailsData.indirectassetvalue.currency}
                            onChange={formik.handleChange}
                    ...
                    <Grid item xs={9} >
                        <TextField
                            ...
                            value={formik.values.directassetvaluenumber || assetDetailsData.directassetvalue.number}
                            onChange={formik.handleChange}
                    ...
                    <TextField
                            ...
                            label="Currency"
                            value={formik.values.directassetvaluecurrency || assetDetailsData.directassetvalue.currency}
                            onChange={formik.handleChange}
